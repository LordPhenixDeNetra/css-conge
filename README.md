...
```
java -Dspring.profiles.active=production -jar ./target/CSSConge-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=sn.css/c-s-s-conge
```
